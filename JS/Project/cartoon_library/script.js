...
const cartoons=[
  {
    ...
    "Poster": "https://th.bing.com/th/id/OIG1.Xoi9NvT7Sb3qYI3_Lmbg?pid=ImgGn",
    "Metascore": "83",
    "imdbRating": "7.9",
    "imdbVotes": "890,617",
    "imdbID": "tt0499549",
  ...
  },
  {
    ...
    "Poster": "https://th.bing.com/th/id/OIG3.pHsXfu9dJBc8rkVmxWYp?w=1024&h=1024&rs=1&pid=ImgDetMain",
    "Metascore": "65",
    "imdbRating": "7.2",
    "imdbVotes": "533,874",
    "imdbID": "tt0480249",
  ...
  },
  {
    ...
    "Poster": "https://th.bing.com/th/id/OIG4.7gDJ_dED52yN.MvOP5H5?pid=ImgGn",
    "Metascore": "52",
    "imdbRating": "7.7",
    "imdbVotes": "611,046",
    "imdbID": "tt0416449",
  ...
  },
  {
    ...
    "Poster": "https://th.bing.com/th/id/OIG1.jjDcrfJ.W9UoRqaSsZHO?w=1024&h=1024&rs=1&pid=ImgDetMain",
    "Metascore": "69",
    "imdbRating": "8.1",
    "imdbVotes": "1,003,301",
    "imdbID": "tt0848228",
  ...
  },
  {
    ...
    "Poster": "https://th.bing.com/th/id/OIG1.SowLucB1TBCwb7RrIFhS?w=1024&h=1024&rs=1&pid=ImgDetMain",
    "Metascore": "75",
    "imdbRating": "8.2",
    "imdbVotes": "786,985",
    "imdbID": "tt0993846",
  ...
  },
  {
    ...
    "Poster": "https://th.bing.com/th/id/OIG4.qjObXdtRGuQVH8X.bKZh?pid=ImgGn",
    "Metascore": "74",
    "imdbRating": "8.6",
    "imdbVotes": "937,412",
    "imdbID": "tt0816692",
  ...
  },
  {
    ...
    "Poster": "https://th.bing.com/th/id/OIG1.JXR8y5dqyd8ZQpWMf10f?w=1024&h=1024&rs=1&pid=ImgDetMain",
    "Metascore": "N/A",
    "imdbRating": "9.5",
    "imdbVotes": "1,046,830",
    "imdbID": "tt0944947",
  ...
  },
  {
    ...
    "Poster": "https://th.bing.com/th/id/OIG1.yc9Gr7EPp9nFe4kIrxls?w=1024&h=1024&rs=1&pid=ImgDetMain",
    "Metascore": "N/A",
    "imdbRating": "8.6",
    "imdbVotes": "198,041",
    "imdbID": "tt2306299",
  ...
  },
  {
    ...
    "Poster": "https://th.bing.com/th/id/OIG4.VKQxfGuN.IBdnMN2LqRF?pid=ImgGn",
    "Metascore": "N/A",
    "imdbRating": "8.0",
    "imdbVotes": "133,375",
    "imdbID": "tt3749900",
  ...
  },
  {
    ...
    "Poster": "https://th.bing.com/th/id/OIG4.ou4M97nj3CUKu2EQ235G?w=1024&h=1024&rs=1&pid=ImgDetMain",
    "Metascore": "N/A",
    "imdbRating": "8.0",
    "imdbVotes": "14,770",
    "imdbID": "tt3281796",
  ...
  },
  {
    ...
    "Poster": "https://th.bing.com/th/id/OIG1.X5Dj2e7MkMW2AQPrrKdv?w=1024&h=1024&rs=1&pid=ImgDetMain",
    "Metascore": "N/A",
    "imdbRating": "8.9",
    "imdbVotes": "118,680",
    "imdbID": "tt2707408",
  ...
  },
  {
    ...
    "Poster": "https://th.bing.com/th/id/OIG3.iW3FLmEfuv6OllsO0ige?pid=ImgGn",
    "Metascore": "N/A",
    "imdbRating": "9.5",
    "imdbVotes": "889,883",
    "imdbID": "tt0903747",
  ...
  },
  {
    ...
    "Country": "USA",
    "Awards": "N/A",
    "Poster": "https://th.bing.com/th/id/OIG1.JEuJXPSNAmeGIA4Aq_Ge?w=1024&h=1024&rs=1&pid=ImgDetMain",
    "Metascore": "N/A",
    "imdbRating": "N/A",
    "imdbVotes": "N/A",
    "imdbID": "tt1211837",
  ...
  },
  {
    ...
    "Country": "USA",
    "Awards": "1 nomination.",
    "Poster": "https://th.bing.com/th/id/OIG2.kNpVO_bxQ0nrR_CTEszp?w=1024&h=1024&rs=1&pid=ImgDetMain",
    "Metascore": "N/A",
    "imdbRating": "N/A",
    "imdbVotes": "N/A",
    "imdbID": "tt3748528",
  ...
  },
  {
    ...
    "Country": "USA",
    "Awards": "N/A",
    "Poster": "https://th.bing.com/th/id/OIG2.9Y6ZnlBm1H6m5xmroyYf?pid=ImgGn",
    "Metascore": "N/A",
    "imdbRating": "N/A",
    "imdbVotes": "N/A",
    "imdbID": "tt3322314",
...
//     data.forEach(function(cartoon, i) {
//         const div = document.createElement('div');
//         div.classList.add('cartoon');

//         const image = document.createElement('img');
//         image.setAttribute('src', cartoon.Poster);
...
//         year.textContent = "Year: " + cartoon.Year;

//         const actors = document.createElement('div');
//         cartoon.Actors.split(', ').forEach(function(a) {
...
//         desc.textContent = cartoon.Plot.slice(0, 100) + " ...";

//         const button = document.createElement('button');
//         button.textContent = "Add to favourite 💗";
//         button.addEventListener('click', function(event) {
//             incr(cartoon.Title, event);
//         });
...
// Update the count of cartoons
countDiv.textContent = `Total Cartoons: ${cartoons.length}`;
...
function displayCartoons(cartoons) {
    cartoons.forEach((cartoon, index) => {
        ...
        cartoonDiv.innerHTML = `
            <img src="${cartoon.Poster}" alt="${cartoon.Title} Poster">
            <h2>${cartoon.Title}</h2>
            <p><strong>Year:</strong> ${cartoon.Year}</p>
            <p><strong>Actors:</strong> ${cartoon.Actors}</p>
            <button onclick="showDetails(${index})">More Details</button>
        `;
...
window.showDetails = function (index) {
    ...
    modalBody.innerHTML = `
        <h2>${cartoon.Title}</h2>
        <p><strong>Plot:</strong> ${cartoon.Plot}</p>
        <p><strong>Director:</strong> ${cartoon.Director}</p>
        <p><strong>Actors:</strong> ${cartoon.Actors}</p>
        <p><strong>Language:</strong> ${cartoon.Language}</p>
        <p><strong>Country:</strong> ${cartoon.Country}</p>
        <p><strong>Awards:</strong> ${cartoon.Awards}</p>
        <div class="images">
            ${cartoon.Images.map(img => `<img src="${img}" alt="${cartoon.Title} Image">`).join('')}
        </div>
    `;
...
// Example function to open the modal (you can modify this as needed)
function openModal() {
  document.getElementById('modal').style.display = 'block';
}

// Add this line to show the modal for testing purposes
// Remove or comment it out after testing
document.getElementById('modal').style.display = 'block';